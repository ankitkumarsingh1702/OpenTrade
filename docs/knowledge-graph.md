...
├── Visual authority
│   ├── page-level screen.png references
│   ├── matching code.html copy and geometry
│   └── Kinetic Apex faceted geometry with the approved Outer Space / Perfect White palette override
├── Shared shell
...
└── Production delivery
    ...
    ├── stable opentrade service URL verification after promotion
